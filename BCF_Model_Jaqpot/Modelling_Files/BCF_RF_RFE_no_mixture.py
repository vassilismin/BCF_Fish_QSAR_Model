...
constant_features = ['Exposure Concentration (ug/L)', 'Mixture', 'Species_Cyprinus carpio', 
...
columns_to_drop = ['PFBS_mixture', 'Exposure (days)', 
                     'Depuration (days)',
...
x_train_final.sort_index().to_csv('BCF_Modeling_dataset/x_train.csv', index=True)
x_test_final.sort_index().to_csv('BCF_Modeling_dataset/x_test.csv', index=True)
y_train.sort_index().to_csv('BCF_Modeling_dataset/y_train.csv', index=True)
y_test.sort_index().to_csv('BCF_Modeling_dataset/y_test.csv', index=True)
pd.DataFrame(y_pred_train).sort_index().to_csv('BCF_Modeling_dataset/y_train_pred.csv', header=False, index=True)
pd.DataFrame(y_pred_test).sort_index().to_csv('BCF_Modeling_dataset/y_test_pred.csv', header=False, index=True)
...
scrambling_results.to_csv('BCF_Modeling_dataset/y_scrambling_results.csv')
